...
def delete_third_and_seventh(input_list):
    ...
    """
    #this is better to do the item near the end first because 
    # then it doesn't affect the order when you do one earlier
    del input_list[6]
    del input_list[2]
...
##feedback-- think about lists of any length and how you can accomodate in our code